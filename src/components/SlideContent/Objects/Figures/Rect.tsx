...
function Rect(props: Props) {
    const rectWidth = Math.round(props.ownProps.figure.width)
    const rectHeight = Math.round(props.ownProps.figure.height)
    const rectStroke = props.ownProps.figure.border ? props.ownProps.figure.border.borderColor : ''
    const rectStrokeSize = props.ownProps.figure.border ? Math.round(props.ownProps.figure.border.borderSize) : 0
